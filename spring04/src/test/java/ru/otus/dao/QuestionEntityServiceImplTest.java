...
import ru.otus.spring.dao.QuestionEntityDaoImpl;
import ru.otus.spring.domain.QuestionEntity;
import ru.otus.spring.service.LocalizationServiceImpl;
...
@SpringBootTest(classes = {QuestionEntityServiceImpl.class, QuestionEntityDaoImpl.class, LocalizationServiceImpl.class})
